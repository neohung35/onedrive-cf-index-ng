...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'neohung@msoppo.eu.org',
  ...
  footer:
    'Powered by <a href="https://github.com/neohung35/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by lyc8503.',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/neohung35',
    },
  ],
